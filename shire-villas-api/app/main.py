...
app = FastAPI(title=settings.PROJECT_NAME, version="6.0.0", lifespan=lifespan)
...
@app.get("/health")
def health(): return {"status":"ok","env":settings.ENV,"version":"6.0.0","system":"Shire Villas Buyer Intelligence OS V6"}
...
def auth_check():
    return {"ok": True, "authenticated": True, "version": "6.0.0"}
