...
app = FastAPI(title=settings.PROJECT_NAME, version="4.0.0", lifespan=lifespan)
...
@app.get("/health")
def health(): return {"status":"ok","env":settings.ENV,"version":"4.0.0","system":"Shire Villas AI Revenue OS V4"}
